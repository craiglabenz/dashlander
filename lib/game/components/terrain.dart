...
class TerrainComponent extends PositionComponent {
  ...
  void render(Canvas canvas) {
    ...
    for (int i = 0; i < points.length - 1; i++) {
      ...
      canvas.drawPath(depthPath, Paint()..color=const Color(0xFF111122)..style=PaintingStyle.stroke);
    }
    ...
    canvas.drawPath(frontPath, Paint()..color = const Color(0xFF01050A));
    ...
    for (int i = 0; i < points.length - 1; i++) {
      ...
      Color baseColor = isPad ? const Color(0xFFFFFF00) : const Color(0xFF00FFFF);
